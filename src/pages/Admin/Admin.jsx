...
export const Admin = () => {
  ...
  // function BootstrapModal({ appointmentData, inputHandler, token }) {
  ...
  //   try {
  //     await updateAppointment(appointmentData, token);
                    ...
                    <MDBTableBody>
                      <tr>
                        ...
                        <td>
                          ...
                          {/* <div className="delete-button" onClick={() => updateAppointmentStepOne(Appointment.id)} ></div>
                          <div className={
                            // botón de confirmación de borrado que comprueba si el useState que lleva el registro de qué usuario
                            // se está borrando es el suyo, en cuyo caso se muestra.
                            areYouDeletingMe === Appointment.id
